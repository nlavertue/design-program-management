...
const CurvedLineDashed = /*#__PURE__*/React.forwardRef(function CurvedLineDashed({
  children,
  size = 16,
  ...rest
}, ref) {
...
if (process.env.NODE_ENV !== "production") {
  CurvedLineDashed.propTypes = iconPropTypes;
}
const CurvedLineSolid = /*#__PURE__*/React.forwardRef(function CurvedLineSolid({
  children,
  size = 16,
  ...rest
}, ref) {
...
if (process.env.NODE_ENV !== "production") {
  CurvedLineSolid.propTypes = iconPropTypes;
}
